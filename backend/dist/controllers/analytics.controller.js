...
exports.getOrgAnalytics = void 0;
const Task_model_1 = __importDefault(require("../models/Task.model"));
const Project_model_1 = __importDefault(require("../models/Project.model"));
const getOrgAnalytics = async (req, res) => {
    try {
        const orgId = req.organization._id;
        const projects = await Project_model_1.default.find({ organizationId: orgId });
        const projectIds = projects.map((project) => project._id);
        const tasks = await Task_model_1.default.find({ projectId: { $in: projectIds } }).populate("assigneeId", "name");
        const statusCounts = {
            todo: 0,
            in_progress: 0,
            in_review: 0,
...
exports.getOrgAnalytics = getOrgAnalytics;
